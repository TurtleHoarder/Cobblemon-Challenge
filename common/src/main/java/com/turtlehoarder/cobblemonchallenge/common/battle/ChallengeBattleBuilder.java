...
public class ChallengeBattleBuilder {
    ...
    public void lvlxpvp(ServerPlayer player1, ServerPlayer player2, int level, List<Integer> player1Selection, List<Integer> player2Selection) throws ChallengeBuilderException {
        ...
        BattleBuilder.INSTANCE.pvp1v1(player1, player2, p1Party.get(player1Selection.get(0)).getUuid(), p2Party.get(player2Selection.get(0)).getUuid(), bf, true, true )
                .ifSuccessful(battle -> {
